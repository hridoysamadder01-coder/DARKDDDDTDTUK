...
const VSTEPS: VStep[] = [
  { text: 'SEARCHING NETWORK...', kind: 'dim', pct: 12 },
  { text: 'SCANNING TRANSACTION POOL...', kind: 'dim', pct: 26 },
  { text: 'BLOCK RESPONSE DETECTED...', kind: 'ok', pct: 40 },
  { text: 'CHECKING SIGNATURE...', kind: 'dim', pct: 54 },
  { text: 'VALIDATING ACCESS TOKEN...', kind: 'dim', pct: 66 },
  { text: 'CONFIRMATIONS: 1', kind: 'ok', pct: 74 },
  { text: 'CONFIRMATIONS: 2', kind: 'ok', pct: 82 },
  { text: 'CONFIRMATIONS: 3', kind: 'ok', pct: 90 },
]
  ...
  return (
    ...
    >
      ...
      {mismatch && (
        ...
        >
          <GlitchText text="SIGNATURE MISMATCH" always />
        </motion.div>
      )}
